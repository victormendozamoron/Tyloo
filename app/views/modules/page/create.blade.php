...
{{-- Page title --}}
@section('title')
@lang('modules/page/views.create.page_title') - @parent
@stop

{{-- Page content --}}
@section('content')
<div class="page-header">
	<h3>@lang('modules/page/views.create.page_title')</h3>
</div>

{{ Form::open(array('route' => 'page.store', 'files' => true, 'class' => 'form-horizontal page_form', 'role' => 'form')) }}
